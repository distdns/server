...
const LOG_FILE_PATH = './analytics-server.log'
const LOG_SIZE_LIMIT = 1024 /* 1kb */ * 1024 /* 1mb */ * 32 /* 32mb */

var queriesSpeed = dWebNetSpeed()
var multicastQueriesSpeed = dWebNetSpeed()
var queriesPS = []
...
exports.createServer = function (disc, opts = {}) {
  ...
  return http.createServer((req, res) => {
    ...
    if (req.url === '/' || req.url === '/index.html') {
      ...
      dWebChannel(fs.createReadStream('./analytics-server/index.html'), res)
    } else if (req.url === '/index.css') {
      res.writeHead(200, {'Content-Type': 'text/css'})
      dWebChannel(fs.createReadStream('./analytics-server/index.css'), res)
    } else if (req.url === '/index.js') {
      res.writeHead(200, {'Content-Type': 'application/javascript'})
      dWebChannel(fs.createReadStream('./analytics-server/index.js'), res)
      ...
      dWebChannel(logFile.createReadStream(), res)
    } else {
